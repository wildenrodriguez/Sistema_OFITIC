...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2025 a las 06:16:37
...
('102', 1, 1, 'asd', 'Nuevo', 'V-31843937', 1, 1),
('213', 1, 2, '12sa', 'Nuevo', 'V-31843937', 2, 1);
...
CREATE TABLE `dependencia` (
  ...
  `direccion_dependencia` varchar(100) NOT NULL,
  `telefono_dependencia` varchar(15) NOT NULL,
...
INSERT INTO `dependencia` (`id_dependencia`, `nombre_dependencia`, `direccion_dependencia`, `telefono_dependencia`, `nombre_responsable`, `estatus`) VALUES
(1, 'OFITIC', '', '', '', 1),
(3, 'Auditoria ', '', '', '', 0),
(4, 'Administración y finanzas', '', '', '', 0);
...
INSERT INTO `equipo` (`id_equipo`, `tipo_equipo`, `serial`, `codigo_bien`, `id_dependencia`, `estatus`) VALUES
(2, '12123', '3123', '102', 1, 0),
(3, '12123', '3123', '102', 1, 1);
...
CREATE TABLE `solicitud` (
  ...
  `estato_solicitud` varchar(20) NOT NULL DEFAULT 'Pendiente',
...
INSERT INTO `solicitud` (`nro_solicitud`, `cedula_solicitante`, `motivo`, `id_equipo`, `fecha_solicitud`, `estato_solicitud`, `resultado_solicitud`, `estatus`) VALUES
(2, 'V-1234567', 'Reparar mi equipo', NULL, '2025-04-08 00:00:00', 'Pendiente', NULL, 0),
(3, 'V-1234567', 'Quiero arreglar el PC', NULL, '2025-04-09 00:00:00', 'En Proceso', NULL, 0),
(4, 'V-1234567', 'Quiero arreglar el PC', NULL, '2025-04-09 00:00:00', 'En Proceso', NULL, 0),
(5, 'V-30266398', 'Se daño el pc', NULL, '2025-04-23 00:00:00', 'En Proceso', NULL, 0),
(34, 'V-31843937', 'hjgjh', NULL, '2025-04-27 00:00:00', 'En Proceso', NULL, 0),
(35, 'V-31843937', 'lkjkjk', NULL, '2025-04-27 00:00:00', 'En Proceso', NULL, 0);
...
INSERT INTO `unidad` (`id_unidad`, `nombre_unidad`, `estatus`) VALUES
(1, 'Gobernación', 0),
(2, 'Baradidas', 0),
(3, 'Teatro Juares', 0),
(4, 'Imprenta de Lara', 0),
(5, 'Secretaria de Gobierno', 0);
...
ALTER TABLE `equipo`
  ...
  ADD KEY `equipo_ibfk_2` (`id_dependencia`),
...
--
ALTER TABLE `solicitud`
  MODIFY `nro_solicitud` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT de la tabla `tipo_bien`
--
ALTER TABLE `tipo_bien`
  MODIFY `id_tipo_bien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
ALTER TABLE `equipo`
  ...
  ADD CONSTRAINT `equipo_ibfk_4` FOREIGN KEY (`id_dependencia`) REFERENCES `dependencia` (`id_dependencia`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `hoja_servicio`
--
ALTER TABLE `hoja_servicio`
  ADD CONSTRAINT `hoja_servicio_ibfk_1` FOREIGN KEY (`nro_solicitud`) REFERENCES `solicitud` (`nro_solicitud`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hoja_servicio_ibfk_2` FOREIGN KEY (`id_tipo_servicio`) REFERENCES `tipo_servicio` (`id_tipo_servicio`) ON UPDATE CASCADE,
  ADD CONSTRAINT `hoja_servicio_ibfk_3` FOREIGN KEY (`redireccion`) REFERENCES `hoja_servicio` (`codigo_hoja_servicio`),
  ADD CONSTRAINT `hoja_servicio_ibfk_4` FOREIGN KEY (`cedula_tecnico`) REFERENCES `empleado` (`cedula_empleado`) ON UPDATE CASCADE;
...
ALTER TABLE `interconexion`
  ...
  ADD CONSTRAINT `interconexion_ibfk_3` FOREIGN KEY (`codigo_patch_panel`) REFERENCES `patch_panel` (`codigo_bien`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `material`
--
ALTER TABLE `material`
  ADD CONSTRAINT `material_ibfk_1` FOREIGN KEY (`ubicacion`) REFERENCES `oficina` (`id_oficina`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `movimiento_materiales`
--
ALTER TABLE `movimiento_materiales`
  ADD CONSTRAINT `movimiento_materiales_ibfk_1` FOREIGN KEY (`id_material`) REFERENCES `material` (`id_material`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `oficina`
--
ALTER TABLE `oficina`
  ADD CONSTRAINT `oficina_ibfk_1` FOREIGN KEY (`id_piso`) REFERENCES `piso` (`id_piso`) ON UPDATE CASCADE;
...
ALTER TABLE `punto_conexion`
  ...
  ADD CONSTRAINT `punto_conexion_ibfk_3` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `solicitud`
--
ALTER TABLE `solicitud`
  ADD CONSTRAINT `solicitud_ibfk_1` FOREIGN KEY (`cedula_solicitante`) REFERENCES `empleado` (`cedula_empleado`) ON UPDATE CASCADE,
  ADD CONSTRAINT `solicitud_ibfk_2` FOREIGN KEY (`id_equipo`) REFERENCES `equipo` (`id_equipo`) ON UPDATE CASCADE;
