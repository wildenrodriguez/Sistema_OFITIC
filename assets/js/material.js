		...
		columns: [
			...
			{ data: 'lugar' },
			{
				data: null, render: function () {
					return '<button onclick=rellenar(this, 0) class="btn btn-primary"><i class="fa-solid fa-arrow-up-wide-short"></i></button><button onclick=rellenar(this, 1) class="btn btn-danger"><i class="fa-solid fa-arrow-down-wide-short"></i></button>';
				}
			},
			{
				data: null, render: function () {
